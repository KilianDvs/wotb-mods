let fs,inquirer,chalk,runUninstallation;_d8c‍.x([["default",()=>profileBgBackup]]);_d8c‍.w("fs-extra",[["default",["fs"],function(v){fs=v}]]);_d8c‍.w("inquirer",[["default",["inquirer"],function(v){inquirer=v}]]);_d8c‍.w("chalk",[["default",["chalk"],function(v){chalk=v}]]);_d8c‍.w("../../uninstall",[["default",["runUninstallation"],function(v){runUninstallation=v}]]);




               async function profileBgBackup(options) {
...
/** Stop the process if the user doesn't want to uninstall the mods */
    if(!goOn.confirmation) {
      _d8c‍.g.console.log(chalk.red("The installation has been cancelled."))
      process.exit(1)
    }
