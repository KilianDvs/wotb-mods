let fs,inquirer,chalk,runUninstallation;_bc3‍.x([["default",()=>avatarBackup]]);_bc3‍.w("fs-extra",[["default",["fs"],function(v){fs=v}]]);_bc3‍.w("inquirer",[["default",["inquirer"],function(v){inquirer=v}]]);_bc3‍.w("chalk",[["default",["chalk"],function(v){chalk=v}]]);_bc3‍.w("../../uninstall",[["default",["runUninstallation"],function(v){runUninstallation=v}]]);




               async function avatarBackup(options) {
...
/** Stop the process if the user doesn't want to uninstall the mods */
    if(!goOn.confirmation) {
      _bc3‍.g.console.log(chalk.red("The installation has been cancelled."))
      process.exit(1)
    }
