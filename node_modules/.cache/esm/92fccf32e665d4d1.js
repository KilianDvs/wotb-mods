let chalk,fs,runUninstallation,inquirer;_e66‍.x([["default",()=>otherModsBackup]]);_e66‍.w("chalk",[["default",["chalk"],function(v){chalk=v}]]);_e66‍.w("fs-extra",[["default",["fs"],function(v){fs=v}]]);_e66‍.w("../../uninstall",[["default",["runUninstallation"],function(v){runUninstallation=v}]]);_e66‍.w("inquirer",[["default",["inquirer"],function(v){inquirer=v}]]);




               async function otherModsBackup(options) {
...
/** Stop the process if the user doesn't want to uninstall the mods */
    if(!goOn.confirmation) {
      _e66‍.g.console.log(chalk.red("The installation has been cancelled."))
      process.exit(1)
    }
