let chalk,fs;_4b7‍.x([["default",()=>runUninstallation]]);_4b7‍.w("chalk",[["default",["chalk"],function(v){chalk=v}]]);_4b7‍.w("fs-extra",[["default",["fs"],function(v){fs=v}]]);


               async function runUninstallation(options) {
  ...
  if(!fs.readdirSync(pathToBackup).filter(f => !f.startsWith(".")).length && !fs.existsSync(`${pathToImages}/Backup`)) {
    _4b7‍.g.console.error(chalk.red("Error while uninstalling the mods : there are no mods to uninstall."))
    process.exit(1)
  }
