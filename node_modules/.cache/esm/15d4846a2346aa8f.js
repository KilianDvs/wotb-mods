let chalk,fs,inquirer;_234‍.x([["default",()=>installImagesMod]]);_234‍.w("chalk",[["default",["chalk"],function(v){chalk=v}]]);_234‍.w("fs-extra",[["default",["fs"],function(v){fs=v}]]);_234‍.w("inquirer",[["default",["inquirer"],function(v){inquirer=v}]]);



               async function installImagesMod(options) {
  ...
  if(questions.length) {
    ...
    if(answers.avatar || answers.background) {
      ...
      _234‍.g.console.log(chalk.red("The installation has be aborted."))
    }
  }
}